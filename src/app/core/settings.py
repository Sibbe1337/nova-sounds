...
# Set development mode explicitly for debugging
if DEBUG_MODE:
...
THUMBNAIL_STORAGE_DIR = os.environ.get('THUMBNAIL_STORAGE_DIR', os.path.join(BASE_DIR, 'thumbnails'))
...
# Runway ML API
# Ensure we have a default API key if not provided in environment
RUNWAY_API_KEY = os.environ.get("RUNWAY_API_KEY", "")
if not RUNWAY_API_KEY:
    # Use a default test key for development
    DEFAULT_KEY = 'key_57357283b4aa55c5d4a8c0db8652317613c60ada603a5e8ae5da013d71c3abfd9daca973b631d26eb4e74a6c0c5216ba2cf94dd2c2f3155d71ed167f0fdf46b1'
    RUNWAY_API_KEY = DEFAULT_KEY
    os.environ["RUNWAY_API_KEY"] = DEFAULT_KEY
    logging.info(f"Using default Runway ML API key, length: {len(DEFAULT_KEY)}")
else:
    logging.info(f"Runway ML API key is configured with length: {len(RUNWAY_API_KEY)}")
